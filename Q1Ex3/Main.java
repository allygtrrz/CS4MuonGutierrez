public class Main {
    public static void main(String[] args) {
        ...
        System.out.println(a1.name + " has performed a total of " + a1.noOfPerformances + " time(s).");
        System.out.println(a1.name + " has earned a total of " + a1.earnings + " dollars/euros.");
